...
def _collect_model_overrides() -> tuple[str | None, list[str]]:
    hydra_cfg = HydraConfig.get()
    sim_model = hydra_cfg.runtime.choices.get("model")
    sim_model_overrides: list[str] = []
    for override in hydra_cfg.overrides.task:
        if override.startswith("model."):
            sim_model_overrides.append(override)
    return sim_model, sim_model_overrides
...
def main(cfg: DictConfig):
    ...
    sim_model, sim_model_overrides = _collect_model_overrides()
    ...
    _append_override(overrides, "sim_model", sim_model)
    _append_override(overrides, "sim_model_overrides", sim_model_overrides)
