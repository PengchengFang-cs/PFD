...
try:
    ...
    class CuroboPlanner:
        ...
        def __init__(
            ...
            kinematics_cfg = yml_data.get("robot_cfg", {}).get("kinematics", {})
            if not kinematics_cfg.get("asset_root_path"):
                urdf_path = kinematics_cfg.get("urdf_path")
                if urdf_path:
                    # RoboTwin templates leave this unset; curobo needs it to resolve URDF mesh paths.
                    kinematics_cfg["asset_root_path"] = os.path.dirname(urdf_path)
